...
from air_hockey_challenge.air_hockey_challenge.environments.data.iiwas import __file__ as env_path
from air_hockey_challenge.air_hockey_challenge.utils.universal_joint_plugin import UniversalJointPlugin
